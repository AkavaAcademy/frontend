      ...
      subcategories: [
        ...
        },
        {
          ...
          courses: [
            ...
            {
              id: 19,
              title: 'Графичен дизайн - Професионални основи с Adobe',
              slug: 'graphic-design-professional-adobe',
              description: 'Професионален курс за графичен дизайн с фокус върху реални умения, търсени на пазара на труда. Подходящ за възрастни, които искат да се преквалифицират или да надградят своите дизайнерски умения.',
