...
const ParentPortal: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === 'parent@akavaacademy.com' && password === 'demo123') {
        loginWithUser({ 
          id: 2, 
          email: email, 
          name: 'Елена Петрова',
        ...
        setError('Невалиден имейл или парола. За демо използвайте: parent@akavaacademy.com / demo123');
      }
    } catch (err) {
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Следете напредъка на вашето дете и управлявайте обучението
          </p>
        </motion.div>
